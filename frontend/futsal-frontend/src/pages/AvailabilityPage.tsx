...
// Mock branch ID - in real app this would come from route params or selection
...
export function AvailabilityPage() {
  ...
  const fetchAvailability = useCallback(async () => {
    ...
    try {
      const data = await bookingService.getAvailability(DEFAULT_BRANCH_ID, selectedDate);
